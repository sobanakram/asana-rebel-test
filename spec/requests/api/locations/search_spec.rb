...
RSpec.describe 'GET api/locations/search', type: :request do
  ...
  it "should return bad request without query param" do
    get api_locations_search_path(params_with_token)
    expect(response).to have_http_status(:bad_request)
  end

  it "should return not found against unknown location" do
    get api_locations_search_path(params_with_token(query: 'This is not a location'))
    expect(response).to have_http_status(:not_found)
  end

  it "should return location coordinates" do
    get api_locations_search_path(params_with_token(query: 'checkpoint charlie'))
